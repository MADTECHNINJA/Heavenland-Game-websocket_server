...
ALLOWED_HOSTS = [os.environ.get('POD_IP'),'127.0.0.1', 'localhost', 'websocket-server-bt4zme4z7q-uc.a.run.app', '34.107.194.180', 'websocket-server-production-bt4zme4z7q-uc.a.run.app']
...
INSTANCE_CONNECTION_NAME = "extreme-arch-347212:us-central1:heavenland-backend"
DATABASES = {
    'default': {
...
GCLOUD_CDN_THUMBNAIL_PREFIX = "buildings/thumbnails/prod/"
GCLOUD_CDN_BUILDING_THUMBNAIL_URL = GCLOUD_CDN_BUCKET_URL + GCLOUD_CDN_THUMBNAIL_PREFIX
GCLOUD_CDN_CHARACTERS_PREFIX = "characters/prod/"
